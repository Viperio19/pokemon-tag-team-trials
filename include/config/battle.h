...
#define B_FLAG_NO_WHITEOUT          TRUE     // If this flag is set, the player can not white out against Trainers. Please note that the party is not healed automatically!
...
#define B_HIDE_HEALTHBOX_IN_ANIMS           FALSE      // If set to TRUE, healthboxes will be hidden during move animations.
