...
#define BATTLE_TYPE_PLAYER_2_PARTNER   (1 << 14)
...
#define BATTLE_TYPE_POKEDUDE           BATTLE_TYPE_CATCH_TUTORIAL
#define BATTLE_TYPE_MULTIPLAYER        (1 << 29)
#define BATTLE_TYPE_WILD_BOSS          (1 << 30)
...
#define BATTLE_TYPE_INGAME_OR_PLAYER_2_PARTNER (BATTLE_TYPE_INGAME_PARTNER | BATTLE_TYPE_PLAYER_2_PARTNER)
#define BATTLE_TYPE_MULTI_OR_PLAYER_2_PARTNER (BATTLE_TYPE_MULTI | BATTLE_TYPE_PLAYER_2_PARTNER)
#define BATTLE_TYPE_TOWER_OR_LINK_MULTI     (BATTLE_TYPE_BATTLE_TOWER | BATTLE_TYPE_TOWER_LINK_MULTI)
#define BATTLE_TYPE_MULTIPLAYER_2_VS_1      ((gBattleTypeFlags & BATTLE_TYPE_MULTIPLAYER && TRAINER_BATTLE_PARAM.opponentB == 0xFFFF))
