...
extern const u8 BattleScript_LinkMultiBattleWonOrLost[];
...
extern const u8 BattleScript_ActionSelectionCantRunFromTrainer[];
...
extern const u8 BattleScript_EffectEat[];
