...
const u8 gText_ExpandedPlaceholder_He[] = _("he");
const u8 gText_ExpandedPlaceholder_Him[] = _("him");
const u8 gText_ExpandedPlaceholder_His[] = _("his");
const u8 gText_ExpandedPlaceholder_She[] = _("she");
const u8 gText_ExpandedPlaceholder_Her[] = _("her");
const u8 gText_ExpandedPlaceholder_Hers[] = _("hers");
...
const u8 gText_Intro_Shelly_ThisIsAPokemon[] = _("For the mission, you'll be using this\nstandard issue CARVANHA.{PAUSE 96}\p");
const u8 gText_Intro_Courtney_ThisIsAPokemon[] = _("You have been assigned to work\nalongside this NUMEL today.{PAUSE 96}\p");
...
const u8 gText_DadsAdvice[] = _("You cannot use that here.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ChooseGoldeen[] = _("Choose GOLDEEN.");
...
const u8 gText_MenuConnect[] = _("CONNECT");
...
const u8 gText_SavingBadges[] = _("STARDUST");
